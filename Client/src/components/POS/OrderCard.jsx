...
export default function OrderCard({product,handleAdd,handleRemove,count}){
    ...
    return(
        <Card sx={{display:'flex',width:{xs:'16.5rem',sm:'30rem',md:'32.5em',lg:'37.5rem'},height:{xs:'5rem',sm:'6rem',md:'7.5rem'},backgroundColor:'white'}}>
            <CardMedia component="img" image={image} sx={{padding:'.5rem',width:{xs:'4rem',sm:'5rem',md:'6.5rem'}}}/>
            <CardContent sx={{display:'flex',width:{xs:'11rem',sm:'25em',md:'26rem',lg:'37.5rem',padding:'0',overflow:'hidden'}}}>
                <Box sx={{height:{xs:'4rem',sm:'6rem',md:'7.5rem'},padding:{xs:'.5rem'},display:'grid',justifyContent:'space-between'}}>
